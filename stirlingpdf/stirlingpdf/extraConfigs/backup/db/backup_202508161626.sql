...
;              
CREATE USER IF NOT EXISTS "SA" SALT 'f792d058ee0d79a9' HASH '31eb240e205cba3a1dff97636b34918423775dc843c95b8db2a4fbfa27a0e88f' ADMIN;          
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME", "TEAM_ID") VALUES(1, NULL, 'web', TRUE, TRUE, '$2a$10$xoe8vOwIhNKJDCwPmCwgTufcYhVhTC3IWsfv4Omk1j75V.Nwuq1UC', NULL, 'admin', 1);    
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME", "TEAM_ID") VALUES(2, '529f6ed7-b0fe-4bd7-9b5b-110623564ee5', 'web', TRUE, FALSE, '$2a$10$RZaIwd8gaOsWQrutmuMN2uV6jHWtVWTYXqFn4.GLJ0vCM/sThrpV6', NULL, 'STIRLING-PDF-BACKEND-API-USER', 2);         
